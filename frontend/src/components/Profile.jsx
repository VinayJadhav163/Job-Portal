    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-6 sm:p-8">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-6">
          ...
          <Button onClick={() => setOpen(true)} className="self-start sm:self-auto" variant="outline">
            <Pen />
          </Button>
        </div>
        ...
        <div className="max-w-sm w-full grid items-center gap-1.5">
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl p-4 sm:p-6 my-6">
